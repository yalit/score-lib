 ...
 */
final class Version20240811153817 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE score_reference ADD CONSTRAINT FK_F08AB3C2CBC91B24 FOREIGN KEY (main_score_id) REFERENCES score (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
